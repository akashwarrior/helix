...
function ImageUpload({ children, setError }: { children: React.ReactNode, setError: (error: ErrorState) => void }) {
    ...
    const handleImageUpload = (files: FileList | null) => {
        ...
        Array.from(files).forEach((file, idx) => {
            ...
            reader.onerror = () => setError({ type: 'server', message: 'Failed to process image, please try again' });
...
function ImageUploadContent({ children, className }: { children: React.ReactNode, className?: string }) {
...
export function ImageDragContainer({ children, className, setError }: { children: React.ReactNode, className?: string, setError: (error: ErrorState) => void }) {
    return (
        <ImageUpload setError={setError}>
            <ImageUploadPreview />
            <ImageUploadContent className={className}>
                {children}
            </ImageUploadContent>
        </ImageUpload>
    );
